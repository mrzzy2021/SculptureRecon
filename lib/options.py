...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_data.add_argument('--dataroot', type=str, default='../RenderPeople',
                            help='path to images (data folder)')
        g_data.add_argument('--sculptureroot', type=str, default='../Sculptures_randc',
                            help='path to images (data folder)')
        g_data.add_argument('--loadSize', type=int, default=512, help='load size of input image')
        g_data.add_argument('--paintingroot', type=str, default='../Paintings',
                            help='path to images (data folder)')
        ...
        g_exp.add_argument('--no_normalization', action='store_true', help='No normalization')
        # g_exp.add_argument('--exp_func', action='store_true', help='Use exp function')
        ...
        g_model.add_argument('--num_stack_stu', type=int, default=4, help='# of hourglass')
        ...
        parser.add_argument('--cdist_clip', action='store_true', help='if not clip')
        ...
        parser.add_argument('--no_tSNE', action='store_true', help='validate errors of test data')
        ...
        parser.add_argument('--results_path', type=str, default='./meshes', help='path to save results ply')
